...
- (UIImage*)buttonImage {
  if (_isLoggedIn) {
    return [UIImage imageNamed:@"facebook/LogoutNormal.png"];
  } else {
    return [UIImage imageNamed:@"facebook/LoginNormal.png"];
  }
}
...
- (UIImage*)buttonHighlightedImage {
  if (_isLoggedIn) {
    return [UIImage imageNamed:@"facebook/LogoutPressed.png"];
  } else {
    return [UIImage imageNamed:@"facebook/LoginPressed.png"];
  }
}
